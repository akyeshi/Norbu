...
@cart_router.route("/checkout", methods=["DELETE"])
@login_required
...
@cart_router.route("/<int:cart_item_id>", methods=["PUT"])
@login_required
...
@cart_router.route("/<int:cart_item_id>", methods=["DELETE"])
@login_required
